...
--
-- Gegevens worden geëxporteerd voor tabel `questionnaire_categories`
--

INSERT INTO `questionnaire_categories` (`id`, `name_en`, `name_nl`, `name_fr`, `description_en`, `description_nl`, `description_fr`, `order`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES
