...
## Clear and refill EDUCAT database
clear = input('Are you sure to clear the EDUCAT database on ' + env.get("DOMAINNAME")  + '?')
if clear[0].lower() == 'y' or clear[0].lower() == 'j':
    command.exec("cd 00.development/dev-educat && python3 migrate-fresh.py && cd ../..");
